...
# CORRECCIÓN: Crear objeto 'egresos' en lugar de 'ingresos'
...
# CORRECCIÓN: Definir niveles correctos para egresos
...
# CORRECCIÓN: Usar niveles_categoria_egresos en lugar de niveles_categoria
egresos$DESCRIPCION_CATEGORIA <- factor(egresos$DESCRIPCION_CATEGORIA, 
                                        levels = niveles_categoria_egresos)

# Agregar columna de categorías principales - CORRECCIÓN: Simplificar case_when
egresos <- egresos |> 
  mutate(
    ...
    # Convertir a factor con orden específico - CORRECCIÓN: Usar los niveles correctos
    CATEGORIA_PRINCIPAL = factor(CATEGORIA_PRINCIPAL, 
                                levels = c("Propios", "No Propios", "Otros"))
  )

# CORRECCIÓN: Cambiar todas las referencias de 'ingresos' a 'egresos'
